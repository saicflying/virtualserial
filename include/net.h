 ...
 */
#define MAX_POLLTIME 6 /* seconds */
#define POLL_TIMEOUT 2 /* seconds */
...
int send_req(int sockfd, struct soe_req *hdr, int hdrlen, void *data, unsigned int wlen, uint32_t);
int exec_req(int sockfd, struct soe_req *hdr, void *,
	      uint32_t);
